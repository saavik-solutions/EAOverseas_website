    ...
    if (!story) {
        return (
            <div className="flex-1 flex flex-col items-center justify-center py-20">
                ...
                <Link to="/testimonials" className="text-[#7a29c2] hover:underline">Back to Testimonials</Link>
            </div>
        );
    }
                ...
                <div className="relative h-[50vh] md:h-[60vh] min-h-[350px] md:min-h-[400px] w-full bg-cover bg-center" style={{ backgroundImage: `url('${story.heroImage}')` }}>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5 md:p-8 lg:p-16 max-w-[1200px] mx-auto text-white">
                        <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                            <span className="px-2.5 md:px-3 py-1 bg-[#7a29c2] text-white text-[10px] md:text-[11px] font-bold uppercase tracking-wider rounded-full">{story.badge}</span>
                ...
                <div className="max-w-[1000px] mx-auto px-4 md:px-6 py-8 md:py-16 grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-12">
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mb-8 md:mb-12 bg-gray-50 p-5 md:p-8 rounded-xl md:rounded-2xl border border-gray-100">
                            <div>
                                <h4 className="text-xs md:text-sm font-bold text-[#7a29c2] uppercase tracking-widest mb-2 md:mb-3 flex items-center gap-1.5 md:gap-2">
                        ...
                        <div className="mt-8 md:mt-16 pt-6 md:pt-8 border-t border-gray-100">
                            <Link to="/testimonials" className="inline-flex items-center gap-2 text-gray-500 hover:text-[#7a29c2] text-sm md:text-base font-semibold transition-colors">
                    ...
                    <div className="lg:col-span-4 space-y-6 md:space-y-8">
                        <div className="bg-[#7a29c2] text-white p-6 md:p-8 rounded-xl md:rounded-2xl lg:sticky lg:top-24">
                            ...
                            <a
                                href="https://student.eaoverseas.com/auth/login"
                                className="block w-full text-center bg-white text-[#7a29c2] text-sm md:text-base font-bold py-3 md:py-4 rounded-lg md:rounded-xl hover:shadow-lg hover:scale-105 transition-all mb-4"
                            >

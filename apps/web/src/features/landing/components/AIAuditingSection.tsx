...
const AIAuditingSection = () => {
    return (
        <section className="relative w-full bg-transparent py-20 md:py-32 overflow-hidden text-slate-900 border-t border-purple-100/50">
            ...
            <div className="absolute top-[-5%] left-[-5%] w-[30%] h-[30%] bg-primary/10 rounded-full blur-[100px] pointer-events-none"></div>
            ...
            <div className="max-w-[1200px] mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center gap-16">
                ...
                <div className="flex-1 space-y-6">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-light/50 border border-purple-200 rounded-full shadow-sm">
                        <span className="material-symbols-outlined text-primary text-sm">auto_awesome</span>
                        <span className="text-primary-hover font-bold text-sm tracking-wide uppercase">AI-Powered Intelligence</span>
                    </div>
                    
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-tight">
                        Predict Your Success with <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-fuchsia-600">Data-Driven Precision.</span>
                    </h2>
                    ...
                    <div className="grid grid-cols-1 gap-4 pt-4">
                        {[
                            ...
                            <div key={i} className="flex gap-4 group cursor-pointer hover:translate-x-1 transition-transform">
                                <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-white border-2 border-primary hover:bg-primary-light/20-light flex items-center justify-center border border-purple-200 group-hover:bg-white border-2 border-primary hover:bg-primary-light/20 group-hover:text-primary font-bold transition-colors duration-300">
                                    <span className="material-symbols-outlined text-primary group-hover:text-white transition-colors">{item.icon}</span>
                                </div>
                                <div className="flex-1">
                                    <h4 className="text-lg font-bold text-slate-800 group-hover:text-primary-hover transition-colors m-0">{item.title}</h4>
                ...
                <div className="flex-1 relative w-full h-[500px] hidden md:flex items-center justify-center" aria-hidden="true">
                        ...
                        {[
                            ...
                            <div key={i} className="p-3 bg-white border border-purple-100/60 rounded-xl shadow-lg w-full animate-[float_5s_ease-in-out_infinite] [animation-delay:0.5s]">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-sm font-black text-primary">{u.chance}</span>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="relative w-32 h-32 flex items-center justify-center bg-white border border-purple-100 rounded-full shadow-2xl z-10">
                        <div className="absolute inset-0 border border-purple-200 rounded-full animate-[spin_8s_linear_infinite]">
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 size-2 bg-primary rounded-full"></div>
                        </div>
                        <span className="material-symbols-outlined text-primary animate-spin-slow text-2xl">progress_activity</span>
                    </div>
